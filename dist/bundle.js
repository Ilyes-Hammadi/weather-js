...
function getWeather(position) {
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get('http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + lon + '&appid=' + KEY).done(function (res) {

				/* Display the local temps */
				var temp = res.main.temp - 273.15;
				__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#tmp").text(temp + "°");
		}).fail(function (err) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_app__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__style_style_scss__ = __webpack_require__(1);
